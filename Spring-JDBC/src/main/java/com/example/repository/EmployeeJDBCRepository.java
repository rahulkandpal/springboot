...
public class EmployeeJDBCRepository {
    ...
    public Page<Employee> findByPage(Pageable p){
    	
    	String query= "select * from employees LIMIT "+ p.getOffset()+","+p.getPageSize();    	
    	List<Employee> emp = jdbcTemplate.query(query,new EmployeeRowMapper());
    	return new PageImpl<>(emp,p,1);
    }
